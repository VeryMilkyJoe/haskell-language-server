...
data Log
  ...
  | LogDidDeleteFiles [FileDelete]
  | LogDidRenameFiles [FileRename]
  deriving Show
...
instance Pretty Log where
  pretty = \case
    ...
    LogDidDeleteFiles files -> "Deleted files:" <+> pretty files
    LogDidRenameFiles files -> "Renamed files:" <+> pretty files
